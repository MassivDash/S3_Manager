...
{#if files.length > 0}
  <table class="table-auto w-full border-spacing-3 p-2 relative">
    <thead
      class="bg-orange-50 dark:bg-slate-800 dark:text-white px-2 sticky top-32 z-10"
    >
    ...
    <tbody>
      {#each files as file}
        <tr
          class="text-gray-700 dark:text-white my-2 py-2 border-orange-100 dark:border-slate-500  border-b-2"
        >
